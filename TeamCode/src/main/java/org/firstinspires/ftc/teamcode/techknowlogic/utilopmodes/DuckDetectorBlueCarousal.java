...
@Autonomous(name = "Duck Detector Blue Left")
//@Disabled
@Config
public class DuckDetectorBlueCarousal extends BaseDuckDetector {
    ...
    public DuckDetectorBlueCarousal(String webcamName, double leftX, double leftY, double rightX, double rightY) {
