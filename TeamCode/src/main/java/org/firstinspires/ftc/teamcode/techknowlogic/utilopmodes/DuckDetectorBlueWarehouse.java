...
//@Disabled
@Config
public class DuckDetectorBlueWarehouse extends BaseDuckDetector {
    ...
    public DuckDetectorBlueWarehouse(String webcamName, double leftX, double leftY, double rightX, double rightY) {
